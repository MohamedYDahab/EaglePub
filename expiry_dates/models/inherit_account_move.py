...
class AccountOrderLineInheritance(models.Model):
    ...
    expiry_date = fields.Text(string="Expiry Date Name", compute="computed_expiry")
        ...
        if mapped_lines.lot_id:
            ...
            for rec in self:
                ...
                for indexes in index_list:
                    # names = ' Lot No. : '+ list_dict['names'][indexes] + 'Product : ' + list_dict['products'][indexes] + '  Expiry: ' + list_dict['dates'][indexes]
